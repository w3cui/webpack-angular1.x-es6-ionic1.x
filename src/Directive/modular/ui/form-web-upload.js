...
import formWebUpload from './form-web-upload.html';
...
export default () => {
	...
	app.directive('modularFormWebUpload', ["$timeout", "$uibModal", "$log", "$document", "$rootScope", ($timeout, $uibModal, $log, $document, $rootScope) => {
		return {
			restrict: 'AE',
			scope: {
				item: "=item"
	...
	app.factory('form.web.upload.service', ["$uibModal","$rootScope", ($uibModal,$rootScope) => {
